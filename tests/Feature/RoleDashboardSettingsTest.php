...
class RoleDashboardSettingsTest extends TestCase
{
    ...
    public function test_superadmin_can_save_visibility_settings_for_each_role(): void
    {
        ...
        $this->assertSame(55, substr_count($settingsPage->getContent(), 'type="checkbox"'));
        $this->assertSame(1, substr_count($settingsPage->getContent(), 'Simpan pengaturan'));

        $this->put(route('settings.roles.update'), [
            'settings' => [
                'superadmin' => ['_present' => '1', 'ticket_number' => '1', 'requester_name' => '1', 'description' => '1', 'whatsapp_number' => '1', 'target' => '1', 'status' => '1', 'comment_tools' => '1', 'edit_submission' => '1', 'actions' => '1', 'completed_at' => '1', 'created_at' => '1'],
                'admin' => ['_present' => '1', 'ticket_number' => '1', 'requester_name' => '1', 'description' => '1', 'whatsapp_number' => '1', 'target' => '1', 'status' => '1', 'comment_tools' => '1', 'edit_submission' => '1', 'actions' => '1', 'completed_at' => '1', 'created_at' => '1'],
                'user' => ['_present' => '1', 'ticket_number' => '0', 'requester_name' => '0', 'description' => '0', 'whatsapp_number' => '0', 'target' => '1', 'status' => '1', 'comment_tools' => '0', 'edit_submission' => '0', 'actions' => '0', 'completed_at' => '1', 'created_at' => '0'],
                'supervisor' => ['_present' => '1', 'ticket_number' => '1', 'requester_name' => '1', 'description' => '1', 'whatsapp_number' => '1', 'target' => '1', 'status' => '1', 'comment_tools' => '1', 'edit_submission' => '1', 'actions' => '1', 'completed_at' => '1', 'created_at' => '1'],
                'owner' => ['_present' => '1', 'ticket_number' => '1', 'requester_name' => '1', 'description' => '1', 'whatsapp_number' => '1', 'target' => '1', 'status' => '1', 'comment_tools' => '1', 'edit_submission' => '1', 'actions' => '1', 'completed_at' => '1', 'created_at' => '1'],
            ],
    ...
    public function test_non_superadmin_roles_cannot_open_or_update_role_settings(): void
    {
        ...
        $this->actingAs($admin)
            ->get(route('settings.roles.edit'))
            ->assertOk()
            ->assertSee('Buat akun dengan role')
